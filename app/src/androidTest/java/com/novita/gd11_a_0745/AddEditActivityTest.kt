package com.novita.gd11_a_0745
...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("Novita"), closeSoftKeyboard())
        ...
        textInputEditText2.perform(scrollTo(), replaceText("10745"), closeSoftKeyboard())
